...
// class ItemsForPendingDelivery extends StatefulWidget {
//   const ItemsForPendingDelivery({super.key});

//   @override
//   State<ItemsForPendingDelivery> createState() =>
//       _ItemsForPendingDeliveryState();
// }

// class _ItemsForPendingDeliveryState extends State<ItemsForPendingDelivery> {
//   late Future<List<PendingDeliveryItem>> _futureItems;
//   List<PendingDeliveryItem> _allItems = [];
//   List<PendingDeliveryItem> _filteredItems = [];
//   final TextEditingController _searchController = TextEditingController();

//   @override
//   void initState() {
//     super.initState();
//     _futureItems = fetchPendingDeliveryItems();
...
//   Future<List<PendingDeliveryItem>> fetchPendingDeliveryItems() async {
...
//       'http://$url/api/Login/dash_ItemsForPendingDelivery',
...
//       final deliverylist =
//           data.map((e) => PendingDeliveryItem.fromJson(e)).toList();
...
//       appBar: AppBar(title: const Text('Items For Pending Delivery')),
//       body: FutureBuilder<List<PendingDeliveryItem>>(
//         future: _futureItems,
...
//                                           ),
//                                           Text(
//                                             'Rate: ${intl.NumberFormat.compact(locale: 'en_IN').format(item.rate)}',
//                                           ),
//                                           Text(
...
class _ItemsForPendingDeliveryState extends State<ItemsForPendingDelivery> {
  late Future<List<PendingDeliveryItem>> _futureItems;
  final List<PendingDeliveryItem> _allItems = [];
  final ValueNotifier<List<PendingDeliveryItem>> _filteredItems = ValueNotifier(
    [],
  );
  final TextEditingController _searchController = TextEditingController();
          ...
          return Padding(
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  child: ValueListenableBuilder<List<PendingDeliveryItem>>(
