...
//   /// Sets up Dio headers for each request.
...
//   /// Gets the base URL from storage.
...
//       if (response.statusCode == 200 && response.data['success'] == true) {
//         final data = response.data['data'] as List?;
//         return data?.isNotEmpty == true ? data!.first : {};
//       }
//       return {};
//     } catch (e) {
//       rethrow;
...
//   Future<bool> createLeadEntry(Map<String, dynamic> body) async {
//     try {
//       await _setupHeaders();
//       final baseUrl = await _getBaseUrl();
...
//   Future<bool> uploadAttachments(List<String> filePaths) async {
//     try {
//       await _setupHeaders();
//       final baseUrl = await _getBaseUrl();
//       const endpoint = "/api/Lead/UploadAttachments";
...
//       },
//     );
//     // If success is false and errorMessage is "Lead_Number_already_exists", return true
