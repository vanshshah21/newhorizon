...
//   Navigator.push(
//     context,
//     MaterialPageRoute(builder: (_) => InquiryDetailsPage(lead: lead)),
//   );
//           },
//           title: Text(
//             'Inquiry#: ${lead.inquiryNumber} | Customer: ${lead.customerName}',
//             style: const TextStyle(fontWeight: FontWeight.bold),
//           ),
//           subtitle: Text(
//             'Salesman: ${lead.salesmanName}\n'
//             'Status: ${lead.inquiryStatus}\n'
//             'Date: ${lead.inquiryDate.split('T').first}',
//           ),
//           trailing: Text(lead.inquiryTypeText),
//         ),
//       ),
//     );
//   }
...
//   // For background amount calculation
...
//     // Offload calculation to background if list is large
//     if (items.length > 10) {
//       _amounts = await compute(_amountsForItems, items);
//     } else {
//       _amounts = items.map((e) => e.itemQty * e.basicPrice).toList();
//     }
...
//             final amount = (idx < amounts.length) ? amounts[idx] : 0.0;
...
//   ) {
//     final theme = Theme.of(context);
//     amount = item.itemQty * item.basicPrice;
//     return Container(
