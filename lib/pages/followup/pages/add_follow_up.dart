...
//   const AddFollowUpForm({Key? key}) : super(key: key);
...
//   // Constants - Get these from your app configuration
//   String baseUrl = "";
...
//       final url = await StorageUtils.readValue('url');
//       final response = await _dio.get(
//         'http://$url/api/Followup/FollowUpMethodofContact?codeType=MF&codeValue=GEN',
//       );
...
//         followUpDate = now.isAfter(periodEDt!) ? periodEDt : now;
//       }
//     } catch (e) {
...
//         'http://$url/api/Followup/FollowUpGetCustomer',
//         data: {
//           "pageNumber": 1,
//           "pageSize": 10,
//           "sortField": "",
...
//         // Inquiry Base
//         final response = await _dio.get(
//           'http://$url/api/Followup/FollowUpEntryGetInquiryNumber',
//           queryParameters: {
...
//         // Quotation Base
//         final response = await _dio.get(
//           'http://$url/api/Followup/FollowUpEntryGetQuotationNumber',
//           queryParameters: {
...
//           children: [
//             Text(
//               value != null ? DateFormat('yyyy-MM-dd').format(value) : 'Select',
//             ),
...
//         "autoId":
//             selectedLeadNumber?['autoId'] ?? selectedQuotationNumber?['autoId'],
//         "baseOn": selectedFollowUpBase,
...
//       final response = await _dio.post(
//         '$baseUrl/api/Followup/FollowUpEntryCreate',
//         data: body,
//       );
...
//                 firstDate: followUpDate ?? periodSDt,
//                 lastDate: periodEDt,
//               ),
//               const SizedBox(height: 16),
//               _buildTimePicker(
