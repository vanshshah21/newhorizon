// lib/pages/add_quotation_item_page.dart

import 'package:flutter/material.dart';
import 'package:flutter_typeahead/flutter_typeahead.dart';
import 'package:nhapp/pages/Quotation2/helpers/quotation_helper.dart';
...
class _AddQuotationItemPageState extends State<AddQuotationItemPage> {
  ...
  // Variables to track item selection.
  ...
  void initState() {
    ...
    // Listen for manual edits to clear selection if changed.
  ...
  /// Convert discount value if the discount type is switched.
  void _updateDiscountValue(String newType) {
    if (_rate != null && _discountValue != null) {
      if (newType == 'Value' && _discountType == 'Percentage') {
        // Convert percentage to actual value.
        final value = (_rate! * (_discountValue! / 100));
        _discountValueController.text = value.toStringAsFixed(2);
      } else if (newType == 'Percentage' && _discountType == 'Value') {
        // Convert value to percentage.
        final percentage = (_discountValue! / _rate!) * 100;
        _discountValueController.text = percentage.toStringAsFixed(2);
      }
  ...
  Future<void> _submit() async {
    ...
    // Prepare empty rate structure details; could be extended.
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items:
                          _discountTypes
                              ...
                              .toList(),
                      onChanged: (v) {
                        if (_discountType != null && v != _discountType) {
                          _updateDiscountValue(v!);
                        }
                        setState(() {
                          _discountType = v;
