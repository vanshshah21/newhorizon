// lib/models/quotation_models.dart
...
// Model for Inquiry Numbers (used in inquiry reference flow)
class Inquiry {
  final String inquiryNumber;

  Inquiry({required this.inquiryNumber});

  factory Inquiry.fromJson(Map<String, dynamic> json) =>
      Inquiry(inquiryNumber: json['inquiryNumber'] ?? '');
}
