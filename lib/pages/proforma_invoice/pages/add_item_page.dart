...
//           basicRateController.text =
//               "0"; // You'll need to add basic rate to SalesItem model
//         });
//       },
//     );
//   }
...
//       ),
//       items:
//           widget.rateStructures
//               .map(
//                 (rs) => DropdownMenuItem<String>(
//                   value: rs.rateStructCode,
//                   child: Text(rs.rateStructFullName),
//                 ),
//               )
//               .toList(),
//       onChanged: (val) {
...
//         });
//         if (val != null) {
//           _fetchRateStructureDetails(val);
//         }
//       },
...
//   Future<void> _fetchRateStructureDetails(String rateStructureCode) async {
//     try {
//       await widget.service.fetchRateStructureDetails(rateStructureCode);
//     } catch (e) {
...
//       discountAmount = basicRate * discountPercentage / 100;
//     } else if (discountType == "Value") {
//       discountAmount = double.parse(discountAmountController.text);
//       discountPercentage = (discountAmount / basicRate) * 100;
//     }
...
//         taxAmount: rateStructureResponse['totalTax'] ?? 0.0,
//         totalAmount: rateStructureResponse['totalAmount'] ?? (basicRate * qty),
//       );
...
//         });
//         if (val != null) {
//           rateStructureDetails = await widget.service.fetchRateStructureDetails(
//             val,
//           );
//         }
//       },
...
//           taxAmount: totalTax,
//           totalAmount: totalAmount,
//           rateStructureRows: rateStructureDetails,
